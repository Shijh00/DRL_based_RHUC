...
#train
#加载数据
wind = np.load('Data//train_wind.npy')
wind_f = np.load('Data//train_wind_f.npy')
wind_r = np.load('Data//train_wind_r.npy')
load = np.load('Data//train_load.npy')
load_scene = np.load('Data//train_load_scene.npy')
noise_var = 0.1
...
#test
wind = np.load('Data//test_wind.npy')
wind_f = np.load('Data//test_wind_f.npy')
wind_r = np.load('Data//test_wind_r.npy')
load = np.load('Data//test_load.npy')
load_scene = np.load('Data//test_load_scene.npy')
